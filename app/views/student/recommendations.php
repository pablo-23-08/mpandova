    ...
    <section class="rounded-3xl border border-white/20 bg-white/95 p-6 shadow-2xl shadow-[#071d3b]/25 sm:p-8">
        ...
        <?php if (empty($recommandations)): ?>
            ...
            <div class="py-16 text-center text-slate-600">
                ...
                <p class="text-sm">
                    Cliquez sur "Générer mes recommandations" pour analyser votre profil.
                </p>
            </div>
        ...
        <?php else: ?>
            ...
            <div class="mt-5 space-y-4">
                ...
                <?php foreach ($recommandations as $i => $reco): ?>
                    ...
                    <a href="index.php?route=student/offer/details&id=<?= (int) $reco['id_offre_filiere'] ?>"
                       class="block rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition
                              hover:border-[#f1b456]/60 hover:shadow-md hover:-translate-y-0.5
                            ...
                            <div class="flex flex-col gap-4 px-2">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="mb-3 flex items-start gap-3">
                                        ...
                                        <span class="inline-flex rounded-lg bg-[#f1b456]/20 px-2 py-1 text-xs font-bold text-[#8a5a10]">
                                            #<?= $i + 1 ?>
                                        </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-1 flex justify-between text-xs text-slate-500">
                                            ...
                                            <span class="font-bold text-[#071d3b]">
                                                <?= $reco['score'] ?>/100
                                            </span>
                                        </div>
